...
public class Enemy4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
           //fires/instantiates when player is behind this gameobject in addition to firing forward
           //instantiation point of lasers firing location might be different than when firing forward or ship will rotate. 
            //stops firing when it leaves scene
    ...
    //tracks location of player. might be similar to Enemy3 before ramming. 
